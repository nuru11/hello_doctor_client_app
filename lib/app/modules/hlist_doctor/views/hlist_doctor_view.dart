...
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:hallo_doctor_client/app/modules/hlist_doctor/views/widgets/hlist_doctor_card.dart';
import 'package:hallo_doctor_client/app/modules/widgets/empty_list.dart';
import 'package:hallo_doctor_client/app/utils/constants/constants.dart';

import '../controllers/hlist_doctor_controller.dart';

class HListDoctorView extends GetView<HListDoctorController> {
  @override
  Widget build(BuildContext context) {
    ...
    void _toggleLang(String value) {
     ...
     print("llllllll ${controller.hdoctorCategory.categoryName}");
